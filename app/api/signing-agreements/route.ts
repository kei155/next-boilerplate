...
interface ISigningAgreement {
    type: string
    title: string
    contents: string
    required: boolean
}
export interface ISigningAgreementResponse {
    signing_agreements: ISigningAgreement[]
}

export async function GET(request: NextRequest) {
  const response: ISigningAgreementResponse = {
    signing_agreements: [
      {
        type: 'sell_agreement',
        title: '판매자 약관',
        contents: `제1조 목적
            ...
            이 약관은 2022.12.09 부터 시행합니다.`.replace(/\n/g, '<br>'),
        required: true,
      },
      {
        ...
        <h2 class="policy-tit">개인정보 수집 및 이용동의 (필수)</h2>
        <div class="policy-cont">
            <div class="policy-list">
                <p>본인은 브랜디(이하 '회사')가 제공하는 셀러 서비스(이하 '서비스')를 이용하기 위해 다음과 같이 회사가 본인의 개인정보를 수집 및 이용하는 것에 동의합니다.</p><br>
                <p><strong>• 귀하께서는 개인정보 수집 및 이용에 대한 동의를 거부하실 수 있으나, 동의를 거부하실 경우 회원가입, 서비스 이용 등을 하실 수 없습니다.</strong></p><br>
                <table style="width: 100%">
                    <thead>
                    <tr>
                        <th scope="col">개인정보 수집 및 이용 목적</th>
                    ...
                    <tr style="vertical-align:top">
                        <td>
                            •<span style="color: red"> 회원가입(사업자 식별)</span><br>
                            • 서비스 제공(문의 및 상담, 정산 서비스 등)<br>
                            • 판매자 관리, 서비스 부정이용 방지
                        </td>
                        <td>
                            <span>• 아이디</span><br>
                            <span>• 비밀번호</span><br>
                            <span>• 핸드폰번호(담당자번호)</span><br>
                            <span>• 셀러명(상호명)</span><br>
                            <span>• 유선 전화번호(고객센터 전화번호)</span><br>
                        </td>
                        <td>
                            <span style="text-decoration-line: underline; font-size: medium; font-weight: bold;">이용계약 종료시</span> 또는<br>
                            <span style="text-decoration-line: underline; font-size: medium; font-weight: bold;">관계법령에 의한 별도 보존기간</span><br>
                            <br>
                            (하단의 관계법령에 의한 개인정보 보존기간 참고)
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <table style="width: 100%">
                    ...
                    <tbody>
                    <tr style="vertical-align:top">
                        <td>세금계산서 발송을 위한 정보수집 및 수탁사 제공</td>
                        <td>(주) 링크허브(팝빌)</td>
                        <td>대표자명, 이메일주소</td>
                        <td><span style="font-weight: bold">이용계약 종료시 또는 관계법령에 의한 별도 보존기간</span> (하단의 관계법령에 의한 개인정보 보존기간 참고)</td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    <tr>
                        <td>
                            ...
                            <ul>
                                ...
                                <li>• 관세에 관한 거래내역 (국세기본법 : 5년)</li>
                                <li>• 서비스 이용기록, 접속로그, 접속 IP정보 (통신비밀보호법 : 3개월)</li>
                            </ul>
                        </td>
                    </tr>
                    </tbody>
                ...
                <br>
                <span>
                    • 원칙적으로 회원의 개인정보는 개인정보의 수집 목적 또는 제공받은 목적이 달성한 후에는 지체 없이 파기하고 있습니다.<br>
